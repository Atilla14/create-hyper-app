...
(function(exports) {
  ...
  var execCmd = function (cmd) {
      return Node_ChildProcess.exec(cmd)(Node_ChildProcess.defaultExecOptions)(function (r) {
          return Control_Bind.bind(Control_Monad_Eff.bindEff)(Node_Buffer.toString(Node_Encoding.UTF8.value)(r.stdout))(Control_Monad_Eff_Console.log);
      });
  };
  var app = function (name) {
      return function (pdomUrl) {
          return function __do() {
              execCmd("echo " + name)();
              return Control_Monad_Eff_Console.log("hello there")();
          };
      };
  };
  var main = (function () {
      var setup = Data_Semigroup.append(Node_Yargs_Setup.semigroupYargsSetup)(Node_Yargs_Setup.usage("$0 -n Word1 -p Word2"))(Node_Yargs_Setup.example("$0 --name testApp --pdom default")("(Create project testApp)"));
      return Node_Yargs_Applicative.runY(setup)(Control_Apply.apply(Node_Yargs_Applicative.applyT)(Data_Functor.map(Node_Yargs_Applicative.functorY)(app)(Node_Yargs_Applicative.yarg(Node_Yargs_Applicative.argString)("n")([ "names" ])(new Data_Maybe.Just("A word"))(new Data_Either.Right("No Project name mentioned!"))(true)))(Node_Yargs_Applicative.yarg(Node_Yargs_Applicative.argString)("p")([ "pdom" ])(new Data_Maybe.Just("Something"))(new Data_Either.Left("default"))(true)));
  })();
  exports["app"] = app;
  exports["main"] = main;
